...
With `arrange` we get to decide which column to sort by. To see the states by state, from smallest to largest, we arrange by `rate` instead:
```{r}
murders %>%
  arrange(rate) %>%
  head()
