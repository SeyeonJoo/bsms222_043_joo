...
```{r}
p + geom_density_ridges(jittered_points = TRUE, 
                        position = position_points_jitter(width = 0.05, height = 0), point_shape = '|', point_size = 3, point_alpha = 1, alpha = 0.7)
```
...
The logistic or logit transformation for a proportion or rate $p$ is defined as: $$f(p)=log(p/{1-p})$$
