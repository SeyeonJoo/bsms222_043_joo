...
### 11.6.4 Visual cues to be compares should be adjacent
...
dat %>%
  mutate(location = ifelse(year == 2010, 1, 2), 
         location = ifelse(year == 2015 & 
                             country %in% c("United Kingdom","Portugal"), location+0.22, location),
...
dat %>%
  ...
  xlab("") +
  ylab("") +
  geom_text(data = data.frame(x = 1935, y = 50), mapping = aes(x, y, label = "US average"), color = "black")
```
