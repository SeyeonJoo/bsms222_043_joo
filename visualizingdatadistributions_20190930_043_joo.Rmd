...
Rather than using data, the normal distribution is defined with a mathematical formula. For any interval $(a, b)$, the proportion of values in that interval can be computed using this formula: $$Pr(a<x<b) = ∫{1/√2πs}*e^{−1/2(x−m/s)^2}*dx$$∫
...
```{r}
sixfeeteight <- 1 - pnorm(6*12+8, 69, 3)
world <- sixfeeteight*10^9
150/world
```
